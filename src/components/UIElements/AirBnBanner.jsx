...
AirBnBanner.props = {
	theme: {
		...
		renderChoice(theme, selected) {
			return `
                <span class="rounded-full bg-gray-500 inline-block p-0.5" style="width: 30px; height: 30px; ${
					AirBnBanner.themes[theme]
				}">
...
AirBnBanner.doRender = function (options) {
	return `
        <div class="w-full max-w-5xl mx-auto rounded-xl px-8" style="${
			AirBnBanner.themes[options.theme]
		}">
            <div class="flex">
                ...
                <div class="flex-1 flex relative overflow-hidden -mr-2 aspect-square" style="max-height: 500px">
...
AirBnBanner.preview = function () {
	return `    
        <img class="w-full" src="AirBnBanner.png" />
    `;
};
