    ...
    return (
        ...
        >
            { choices.map((choice, index) => {
                ...
                return (
                    <span key={index} className={`cursor-pointer py-1 px-2 text-sm font-medium tracking-wider ${index < choices.length - 1 && `border-r`} ${selected ? 'bg-dark-gray text-white' : 'text-dark-gray'}`}
